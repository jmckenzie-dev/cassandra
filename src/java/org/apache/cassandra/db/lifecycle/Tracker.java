...
public class Tracker
{
    ...
    {
        view.set(new View(
                         !isDummy() ? ImmutableList.of(new Memtable(new AtomicReference<>(CommitLog.instance.getCurrentSegmentPosition()), cfstore))
     ...
     */
    public Memtable getMemtableFor(OpOrder.Group opGroup, CommitLogSegmentPosition commitLogSegmentPosition)
    {
        ...
        {
            if (memtable.accepts(opGroup, commitLogSegmentPosition))
                return memtable;
        }
