...
public class RowKey implements Comparable<RowKey>
{
    ...
    public boolean equals(Object o)
    {
        ...
        return clustering != null ? comparator.compare(clustering, rowKey.clustering) == 0 : rowKey.clustering == null;
    }
    ...
    public String toString(TableMetadata metadata)
    {
        return String.format("RowKey: { pk : %s, clustering: %s}",
                             metadata.partitionKeyType.getString(decoratedKey.getKey()),
