...
public interface NativeFunctions
{
    ...
    void tryMlockall();
    void trySkipCache(String path, long offset, long len);
    void trySkipCache(int fd, long offset, long len);
    void trySkipCache(int fd, long offset, int len);
