...
public class FileSystemOwnershipCheck implements StartupCheck
{
    ...
    static final String CLUSTER_NAME_PROPERTY                   = "ClusterName";
    ...
    public void execute() throws StartupException
    {
        ...
        if (foundPerTargetDir.values().contains(0))
        {
    ...
    /** In version 1, we check and return the cluster name. Extend this for custom ownership hierarchies. */
