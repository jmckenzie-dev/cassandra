...
public abstract class CommitLogTest
{
    ...
    public void testDontDeleteIfDirty() throws Exception
    {
        ...
        assertEquals(2, CommitLog.instance.segmentManager.getSegmentsForUnflushedTables().size());
    ...
    public void testDeleteIfNotDirty() throws Exception
    {
        ...
        assertEquals(1, CommitLog.instance.segmentManager.getSegmentsForUnflushedTables().size());
        ...
        Collection<CommitLogSegment> segments = CommitLog.instance.segmentManager.getSegmentsForUnflushedTables();
        ...
        segments = CommitLog.instance.segmentManager.getSegmentsForUnflushedTables();
