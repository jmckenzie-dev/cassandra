...
public class FileSystemOwnershipCheckTest
{
    ...
    public void setup() throws IOException
    {
        ...
        System.setProperty(CLUSTER_NAME_PROPERTY, token);
    ...
    @Test
    public void checkEnabledButClusterPropertyIsEmpty() throws Exception
    {
    ...
    @Test
    public void checkEnabledButClusterPropertyIsUnset() throws Exception
    {
    ...
    private static File writeFile(File dir, String filename, int version, int volumeCount, String token)
    throws IOException
    {
