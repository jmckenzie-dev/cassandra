...
public class CompressedSequentialWriterTest extends SequentialWriterTest
{
    ...
    private void testWrite(File f, int bytesToTest) throws IOException
    {
        ...
        try
        {
            MetadataCollector sstableMetadataCollector = new MetadataCollector(new ClusteringComparator(Arrays.<AbstractType<?>>asList(BytesType.instance))).commitLogSegmentPosition(null);
